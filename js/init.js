...
window.onload = function ()
{
    ...
    // VAL добавили вывод Фамилии, отчетства, года, профессии, картинку пола:
    ...
    document.querySelector('#imagegenderOutput').innerHTML = initPerson.imagegender;
};
...
document.querySelector('#clear').onclick = function () {
    ...
    document.querySelector('#imagegenderOutput').innerHTML = "";
}
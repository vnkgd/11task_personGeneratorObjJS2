...
const personGenerator = {
    ...
    // VAL Добавил Json куда хотело бы добавить фотку в зависимости от пола
    imageprofessionJson: `{
        "unisex" : {
            "1": "Разработчик",
            "2": "Дизайнер",
    ...
    // VAL Метод случайной генерации картинки, в зависимости от пола
    randomImageGender: function () {
        if (this.Gender_Parameter == 'Мужчина') {
            return ("<img src='img/man.png' align=center hspace=10 width=100 height100 alt=Мужчина>");
        }
        else if(this.Gender_Parameter == 'Женщина') {
            return ("<img src='img/woman.png' align=center hspace=10 width=100 height100 alt=Женщина>");
        }
    },
    ...
    getPerson: function () {
        ...
        this.person.imagegender = this.randomImageGender();
